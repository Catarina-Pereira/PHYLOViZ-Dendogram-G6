...
export namespace WebUiUris {
    ...
    export const TREE_VIEW_UPGMA = `${TREE_VIEW}/tree-view-upgma`
    ...
    export const COMPUTE_UPGMA = `${COMPUTE_TREE}/upgma`
    ...
    export const tree_upgma = (projectId: string) => `/projects/${projectId}/tree-view-upgma`
    ...
    //export const computeUPGMA = (projectId: string, datasetId: string) => `/projects/${projectId}/datasets/${datasetId}/tree-views-dendofram`
    ...
    export const computeUPGMA = (projectId: string, datasetId: string) => `/projects/${projectId}/datasets/${datasetId}/compute/tree/upgma`
